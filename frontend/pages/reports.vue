          ...
          <Table>
            ...
            <tbody class="bg-gray-200">
              ...
              >
                ...
                <td class="px-5 py-3">
                  <span>{{
                    item?.imperssions !== null ? nFormatter(item?.imperssions,1) : 0
                  }}</span>
                </td>

                <td class="px-5 py-3">
                  <span>{{ item?.clicks !== null ? nFormatter(item?.clicks,1) : 0 }}</span>
                </td>
                <td class="px-5 py-3">
                  <span>${{ item?.revenue !== null ? nFormatter(item?.revenue,1) : 0 }}</span>
                </td>
                <td class="px-5 py-3">
                  <span>${{ item?.eCPM !== null ? nFormatter(item?.eCPM,1) : 0 }}</span>
                </td>
              </tr>
            </tbody>
          </Table>
